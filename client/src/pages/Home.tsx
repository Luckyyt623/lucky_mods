    ...
    <Layout>
      {SelectedModid.id !== null ?  (
        ...
        (() => {
            ...
            if (selectedData) {
              return <div className="flex flex-col gap-[20px] w-full h-full items-center justify-center p-[20px]">

                <SelectedMod  vals={selectedData} HandleClose={CloseSelectedMod} />
              </div>
            }
