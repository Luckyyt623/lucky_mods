...
export default function Navbar() {
    return (
        <nav className="flex w-full justify-between h-full items-center px-[20px]">
            ...
            <p className="text-xl uppercase bg-linear-to-r from-yellow-400  bg-clip-text to-yellow-600 text-transparent font-bold anton tracking-widest  shadow-lg shadow-red-900/10 ">Lucky Mods</p>
