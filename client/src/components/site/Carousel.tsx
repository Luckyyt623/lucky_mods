...
export default function Carousel() {
    return (
        <div className="w-full h-[400px] md:h-[500px] flex items-center relative justify-center">
            ...
            <div className='absolute w-full h-full items-center justify-center gap-[20px] flex flex-col'>
                ...
                <h1 className='text-4xl bg-linear-to-r text-center from-red-300 bg-clip-text to-red-500 text-transparent font-bold anton tracking-widest  shadow-lg shadow-red-900/10'>WELCOME TO LUCKY MODS</h1>

                <p className='text-2lg text-center md:p-[0px] p-[10px] bg-linear-to-r from-sky-500 bg-clip-text to-indigo-500 text-transparent font-bold chau tracking-widest  shadow-lg shadow-red-900/10 uppercase '>Explore exciting mods for Slither.io and stay tuned for Minecraft updates!</p>
