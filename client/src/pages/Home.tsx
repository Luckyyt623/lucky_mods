...
export default function Home() {
  ...
  return (
    <Layout>
      <div className="flex w-full h-[100%] flex-col gap-[20px]">
        ...
        <div className='w-full mt-[70px] flex-col gap-[40px] items-center justify-center flex '>
          ...
          <div className="flex h-5 text-white items-center space-x-4 text-sm">
            <Tabs defaultValue="New" className="w-full">
              <TabsList className="bg-black ">
                <TabsTrigger className="w-[200px]" value="New">New</TabsTrigger>
                <TabsTrigger className="w-[200px]" value="Popular">Popular</TabsTrigger>
              </TabsList>
              <TabsContent value="New">Make changes to your account here.</TabsContent>
